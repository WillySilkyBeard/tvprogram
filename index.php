...
<div class="tv__menu">
	<ul>
		<li><a class="nav-filter-date-link" href="?day=<?="$d[year]-0$d[mon]-$today"?>"><span>Сегодня <span class="nav__day">(<?=$wday." ".$d[mday]?>)</span></span></a></li>
		<li><a class="nav-filter-date-link" href='?day=<?="$d[year]-0$d[mon]-$one"?>'><span><?=$wone?> <span class="nav__day"><?=$d[mday]+1?></span></span></a></li>
		<li><a class="nav-filter-date-link" href="?day=<?="$d[year]-0$d[mon]-$two"?>"><span><?=$wtwo?> <span class="nav__day"><?=$d[mday]+2?></span></span></a></li>
		<li><a class="nav-filter-date-link" href="?day=<?="$d[year]-0$d[mon]-$three"?>"><span><?=$wthree?> <span class="nav__day"><?=$d[mday]+3?></span></span></a></li>
		<li><a class="nav-filter-date-link" href="?day=<?="$d[year]-0$d[mon]-$four"?>"><span><?=$wfour?> <span class="nav__day"><?=$d[mday]+4?></span></span></a></li>
		<li><a class="nav-filter-date-link" href="?day=<?="$d[year]-0$d[mon]-$five"?>"><span><?=$wfive?> <span class="nav__day"><?=$d[mday]+5?></span></span></a></li>
		<li><a class="nav-filter-date-link" href="?day=<?="$d[year]-0$d[mon]-$six"?>"><span><?=$wsix?> <span class="nav__day"><?=$d[mday]+6?></span></span></a></li>
	</ul>
</div>
<?php
